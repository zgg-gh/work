 ...
 * generated in the cn.edu.work package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://127.0.0.1:12345/weather", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://127.0.0.1:12345/weather", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: cn.edu.work
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://work.edu.cn/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://work.edu.cn/", name = "queryWeather")
